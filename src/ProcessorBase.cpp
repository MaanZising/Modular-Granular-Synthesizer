...
void ProcessorBase::processBlock (juce::AudioBuffer<float>& buffer,
...
void ProcessorBase::updateWritePosition (juce::AudioBuffer<float>& buffer)
{
...
void ProcessorBase::triggerGrainBuffer (int channel, juce::AudioBuffer<float>& buffer)
{
    auto bufferSize = buffer.getNumSamples();
...
void ProcessorBase::fillDelayBuffer (int channel, juce::AudioBuffer<float>& buffer)
{
    auto bufferSize = buffer.getNumSamples();
    auto delayBufferSize = delayBuffer.getNumSamples();
...
void ProcessorBase::fillGrainBuffer (int channel, juce::AudioBuffer<float>& delayBuffer)
{
    auto delayBufferSize = delayBuffer.getNumSamples();
